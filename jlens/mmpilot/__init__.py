...
This package is deliberately small. It keeps the multimodal protocol testable
on CPU without a GPU, a model download, or Google Drive. Everything model-facing
